    ...
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-lg-2 text_div">
                <input type="text" class="form-control" id="inputLastName" placeholder="Last/Family Name(s)" required>
            </div>
        ...
        <div class="form-group">
            ...
            <span id='other_ethnicity_detail' style='display:none'>
                ...
                <div class="col-lg-2">
                    <input name="other_ethnicity" class="form-control" id="other_ethnicity" required>
                </div>
            </span>
        </div>
        ...
        <div class="form-group">
            <span id='permanent_resident_question' style='display:none'>
                ...
                <div class="col-lg-2 text_div">
                    <select class="form-control" name="is_permanent_resident" id="is_permanent_resident"
                            onchange="javascript:toggleEnablingAlienResidentNo()">
                        <option value="">Select</option>
                        <option value="y">Yes</option>
                        <option value="n">No</option>
                    </select>
                ...
                <span id='alien_resident_detail' style='display:none'>
                    <label for="alien_resident_no" class="col-lg-2 control-label required">Alien Resident Number</label>
                    <div class="col-lg-2">
                        <input type="text" class="form-control" name="alien_resident_no"
